                  ...
                  <div class="row g-0">
                    ...
                    <div class="col-md-6 col-lg-8 d-flex align-items-center">
                      ...
                      <form @submit.prevent="submitForm" >
                          ...
                          <h5 class=" mb-3 pb-3" style="letter-spacing: 1px;">Enter Rating between 1-10 </h5>
        
                          <div class="form-outline mb-4">
                            <input type="text" id="rate" v-model="rate"
                                                class="form-control form-control-lg" placeholder="Enter value between 1-10"
                                                required />
...
<script>
  ...
  export default {
    ...
    submitForm(){
      // method which takes the show details and the rating of the user and submits the rating
        const formData = {
            ...
            axios.defaults.headers.common['Authorization'] = 'Bearer ' + access_token;
            console.log(formData);
            //calling the rateshow api with the formdata
            axios.put('http://localhost:8081/rateshow', formData)
              .then(response => {
